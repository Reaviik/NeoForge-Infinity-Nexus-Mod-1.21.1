...
public class ModModelLayers {
    public static final ModelLayerLocation ASGREON_LAYER = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath(InfinityNexusMod.MOD_ID, "asgreon_layer"), "asgreon_layer");

    public static final ModelLayerLocation FLARON_LAYER = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath(InfinityNexusMod.MOD_ID, "flaron_layer"), "flaron_layer");
}
