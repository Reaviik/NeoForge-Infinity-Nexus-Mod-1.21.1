...
public class BatteryScreen extends AbstractContainerScreen<BatteryMenu> {
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(InfinityNexusMod.MOD_ID, "textures/gui/battery_gui.png");
    ...
    private void assignEnergyInfoArea() {
        ...
        energyInfoArea = new EnergyInfoArea(x + 44, y + 30, menu.getBlockEntity().getEnergyStorage(null), 106, 14);
    }
    @Override
    ...
    private void renderEnergyAreaTooltips(GuiGraphics pGuiGraphics, int pMouseX, int pMouseY, int x, int y) {
        if(isMouseAboveArea(pMouseX, pMouseY, x, y, 44,  30, 106, 14)) {
